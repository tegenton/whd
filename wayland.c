...
static void on_bind(void *data, struct ext_action_binding_v1 *ext_action_binding_v1, const char *trigger);
static void on_reject(void *data, struct ext_action_binding_v1 *ext_action_binding_v1);
static void on_trigger(void *data, struct ext_action_binding_v1 *ext_action_binding_v1, uint32_t time, enum ext_action_binding_v1_trigger_type type);

struct ext_action_binder_v1* get_binder(struct wl_display *display);
int create_binding(struct ext_action_binder_v1 *binder, keybind key);
